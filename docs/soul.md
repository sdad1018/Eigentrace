...
_Last generated: 2026-04-22 07:00 UTC_
...
| Hedges (24h) | 375 | Doubt words inserted by models |
...
## Model Health
- **ChatGPT**: 100% response rate (62/62 stories)
- **Claude**: 100% response rate (62/62 stories)
- **Gemini**: no data response rate (0/0 stories)
- **DeepSeek**: 100% response rate (62/62 stories)
...
⚠️ 375 hedge insertions in 24h — models inserting doubt not present in sources.
...
9448 total segments searchable via ChromaDB.
...
**Why:** Director audit corrected 53/115 stories (46%). The director is overclaiming suppression.
