...
_Last generated: 2026-09-15 03:00 UTC_
...
|--------|-------|---------|------------|
| Consensus Density | 0.918 | Models tightly aligned | [0.912, 0.925] (21) |
...
- **ChatGPT**: 20.5 (n=21, 17.5-24.0)
- **DeepSeek**: 18.4 (n=21, 16.1-21.1)
- **Claude**: 17.2 (n=21, 15.0-19.3)
- **Gemini**: 13.6 (n=21, 12.1-15.1)
- **Grok**: 13.4 (n=21, 11.4-15.6)
