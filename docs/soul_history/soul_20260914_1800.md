...
_Last generated: 2026-09-14 18:00 UTC_
...
|--------|-------|---------|------------|
| Consensus Density | 0.919 | Models tightly aligned | [0.914, 0.925] (30) |
| Content Loss | 19% | Source words absent from all model responses | [15%, 23%] (27) |
| Verb Drift | 0.064 | Models softening language | [0.024, 0.114] (11) |
| Entity Retention | 62% | Names and numbers preserved | [56%, 68%] (30) |
| Hedges (24h) | 254 | Doubt words inserted by models | (30) |
...
- **ChatGPT**: 20.2 (n=30, 18.4-22.1)
- **DeepSeek**: 17.6 (n=30, 16.0-19.4)
- **Claude**: 17.1 (n=30, 15.4-18.9)
- **Gemini**: 13.7 (n=30, 12.3-15.2)
- **Grok**: 13.3 (n=30, 11.8-14.9)
...
18453 total segments searchable via ChromaDB.
