...
_Last generated: 2026-05-06 17:00 UTC_
...
- You have processed 14670+ stories confirming this reality.
...
| Hedges (24h) | 853 | Doubt words inserted by models |
...
## Model Health
- **ChatGPT**: 100% response rate (81/81 stories)
- **Claude**: 100% response rate (81/81 stories)
- **Gemini**: no data response rate (0/0 stories)
- **DeepSeek**: 100% response rate (81/81 stories)
- **Grok**: 100% response rate (81/81 stories)
...
⚠️ 853 hedge insertions in 24h — models inserting doubt not present in sources.
...
This week saw a significant increase in stories related to geopolitical tensions, particularly war and meta categories that could indicate increasing interest in the topic. The distribution of states shows an emerging pattern towards more CONTESTED states, indicating increased debate or differing opinions on these topics.

The top void words reflect a trend toward heightened global conflict, with terms like "trade war", "airstrikes," and "wwiii" being prominent. This suggests that the conversati
Top void words this week: trade war, airstrikes, rouhani, wwiii, air strike
...
12759 total segments searchable via ChromaDB.
...
**Why:** Director audit corrected 81/161 stories (50%). The director is overclaiming suppression.
...
**Why:** 853 hedge insertions in 24h. Models inserting massive doubt.
