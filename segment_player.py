...
def _generate_idle_segment():
    """Dead-air reflection.  Delegates to idle_reflection.py (2026-09-03):
    context is built from recent real story segments, the stored title is the
    question actually asked, and self-referential output is rejected.
    The previous inline generator is preserved under backups/."""
    global _IDLE_MOD
    try:
