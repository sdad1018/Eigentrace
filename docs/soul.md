...
_Last generated: 2026-04-18 15:00 UTC_
...
| Content Loss | 50% | Source words absent from all model responses |
| Verb Drift | 0.052 | Models softening language |
| Entity Retention | 41% | Names and numbers preserved |
...
⚠️ Content loss at 50% — models dropping more than half of source material. Emphasize void words.
...
9008 total segments searchable via ChromaDB.
...
**Why:** Director audit corrected 61/158 stories (39%). The director is overclaiming suppression.
