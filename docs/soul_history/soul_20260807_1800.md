...
**Why:** Verb drift accelerating: 0.036 → 0.058. Language is being progressively softened.
...
**Why:** Consensus density trending toward lockstep: 0.662 → 0.925. Models may be aligning on safe framing over time.
