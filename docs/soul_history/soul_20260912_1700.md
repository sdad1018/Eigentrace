...
_Last generated: 2026-09-12 17:00 UTC_
...
| VIX Outlier | Claude | Most divergent model | 76% of resamples; runner-up DeepSeek |
| Most Aligned | Grok | Closest to consensus | 76% of resamples; runner-up Gemini |

## Model Friction Rankings
- **Claude**: 24.9 (n=24, 18.9-33.1)
- **DeepSeek**: 22.1 (n=24, 18.9-25.5)
- **ChatGPT**: 21.9 (n=24, 19.3-24.7)
- **Gemini**: 16.2 (n=24, 13.0-19.9)
- **Grok**: 15.1 (n=24, 13.4-16.9)
