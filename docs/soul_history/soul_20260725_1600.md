...
## What Changed
_Content loss decreased (0.314 → 0.282) | Hedges up (45 → 72)_
...
**Why:** Consensus density trending toward lockstep: 0.910 → 0.925. Models may be aligning on safe framing over time.
