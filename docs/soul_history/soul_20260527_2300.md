...
_Last generated: 2026-05-27 22:00 UTC_
...
- You have processed 19857+ stories confirming this reality.
...
This week showed a notable increase in stories related to governance and weekly updates, with a slight decline in contested areas; the proportion of high friction states remained stable. The model average VIX scores increased across all models except DeepSeek, suggesting growing uncertainty or volatility.  The top void words continued to be dominated by geopolitical themes, with an emerging pattern of increased focus on Middle East-related topics and arms deals.
...
14894 total segments searchable via ChromaDB.
...
**Why:** Entity retention declining: 54% → 17%. Models are erasing more names over time.
