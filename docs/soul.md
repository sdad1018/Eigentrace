...
_Last generated: 2026-04-23 09:00 UTC_
...
| Verb Drift | 0.172 | Models softening language |
| Entity Retention | 47% | Names and numbers preserved |
| Hedges (24h) | 419 | Doubt words inserted by models |
...
## Model Health
- **ChatGPT**: 100% response rate (37/37 stories)
- **Claude**: 100% response rate (37/37 stories)
...
⚠️ 419 hedge insertions in 24h — models inserting doubt not present in sources.
...
9504 total segments searchable via ChromaDB.
...
**Why:** Director audit corrected 37/74 stories (50%). The director is overclaiming suppression.
...
### [flag_verb_softening]
**Why:** Verb drift at 0.172 — models actively softening language.
...
**Why:** Verb drift accelerating: 0.120 → 0.183. Language is being progressively softened.
