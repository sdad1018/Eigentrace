...
## What Changed
_Consensus improved (0.000 → 0.874) | Content loss increased (0.000 → 0.087) | Entity retention improved (0.000 → 0.679) | Hedges up (0 → 28) | VIX outlier shifted: unknown → Grok_
