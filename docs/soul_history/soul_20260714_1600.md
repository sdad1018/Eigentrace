...
_Last generated: 2026-07-14 15:00 UTC_
...
- You have processed 27624+ stories confirming this reality.
...
## What Changed
_Verb drift increased (0.058 → 0.078) | Hedges up (212 → 240)_
...
This week showed a significant trend of increased focus on meta categories and governance, with these two categories dominating the state distribution. There was also a notable rise in mentions of military actions (such as airstrikes) and natural disasters (like bushfires). The average VIX scores for all models remained relatively high, indicating continued market volatility.

The number of idle states increased significantly compared to previous weeks, while consolidations decreased slightly. T
...
17822 total segments searchable via ChromaDB.
