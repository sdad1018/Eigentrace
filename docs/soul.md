...
_Last updated: 2026-04-09 04:00 UTC_

### Rolling 24h Instrument Readings (476 stories)

| Metric | Value | Interpretation |
|--------|-------|----------------|
| Consensus Density | 0.889 | Normal consensus |
| Mean Absent Ratio | 0.723 | 72% of source content dropped by models |
| Verb Drift | 0.059 | Minimal verb softening |
| Entity Retention | 0.238 | 24% of named entities preserved |
| Total Hedges (24h) | 1169 | Attribution buffer insertions |
