...
_Last generated: 2026-04-22 11:00 UTC_
...
| Content Loss | 49% | Source words absent from all model responses |
...
- **Grok**: 100% response rate (48/48 stories)
...
9456 total segments searchable via ChromaDB.
...
**Why:** Director audit corrected 44/92 stories (48%). The director is overclaiming suppression.
...
**Why:** Verb drift accelerating: 0.083 → 0.109. Language is being progressively softened.
