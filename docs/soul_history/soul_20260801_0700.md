...
## What Changed
_Content loss increased (0.199 → 0.226) | Verb drift increased (0.261 → 0.355) | Entity retention degraded (0.668 → 0.635) | Hedges down (72 → 49)_
...
**Why:** Verb drift accelerating: 0.185 → 0.221. Language is being progressively softened.
