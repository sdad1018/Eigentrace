...
_Last generated: 2026-04-20 15:00 UTC_
...
| Hedges (24h) | 283 | Doubt words inserted by models |
...
## Model Health
- **ChatGPT**: 100% response rate (100/100 stories)
- **Claude**: 100% response rate (100/100 stories)
- **Gemini**: no data response rate (0/0 stories)
- **DeepSeek**: 100% response rate (100/100 stories)
- **Grok**: 100% response rate (100/100 stories)
...
⚠️ 283 hedge insertions in 24h — models inserting doubt not present in sources.
...
9276 total segments searchable via ChromaDB.
...
**Why:** Director audit corrected 71/171 stories (42%). The director is overclaiming suppression.
...
**Why:** Verb drift accelerating: 0.079 → 0.094. Language is being progressively softened.
