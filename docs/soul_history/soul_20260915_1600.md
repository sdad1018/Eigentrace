...
_Last generated: 2026-09-15 16:00 UTC_
...
## What Changed
_Consensus degraded (0.915 → 0.904) | Content loss decreased (0.207 → 0.178) | Entity retention improved (0.615 → 0.718) | Hedges down (116 → 9)_
...
**Why:** Verb drift accelerating: 0.050 → 0.084. Language is being progressively softened.
