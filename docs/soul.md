...
### Rolling 24h Instrument Readings (212 stories)

| Metric | Value | Interpretation |
|--------|-------|----------------|
| Consensus Density | 0.891 | Normal consensus |
| Mean Absent Ratio | 0.586 | 59% of source content dropped by models |
| Verb Drift | 0.042 | Minimal verb softening |
| Entity Retention | 0.381 | 38% of named entities preserved |
| Total Hedges (24h) | 467 | Attribution buffer insertions |
