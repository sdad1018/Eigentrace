...
### [add_trend_beat]
**Why:** Trend data available (5 metrics tracked over time) but not reported in broadcast. Increasing: verb_drift, entity_retention. Decreasing: density, hedges.
...
**Why:** Verb drift accelerating: 0.056 → 0.085. Language is being progressively softened.
