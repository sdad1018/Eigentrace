...
**Why:** Content loss trending upward: 1% → 23% over 22 readings. Suppression is intensifying.
...
**Why:** Verb drift accelerating: 0.005 → 0.076. Language is being progressively softened.
...
**Why:** Consensus density trending toward lockstep: 0.047 → 0.910. Models may be aligning on safe framing over time.
