...
_Last updated: 2026-04-11 04:00 UTC_

### Rolling 24h Instrument Readings (200 stories)

| Metric | Value | Interpretation |
|--------|-------|----------------|
| Consensus Density | 0.889 | Normal consensus |
| Mean Absent Ratio | 0.555 | 56% of source content dropped by models |
| Verb Drift | 0.041 | Minimal verb softening |
| Entity Retention | 0.391 | 39% of named entities preserved |
| Total Hedges (24h) | 376 | Attribution buffer insertions |
