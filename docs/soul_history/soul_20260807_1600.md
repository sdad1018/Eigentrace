...
**Why:** Verb drift accelerating: 0.034 → 0.064. Language is being progressively softened.
...
**Why:** Consensus density trending toward lockstep: 0.662 → 0.926. Models may be aligning on safe framing over time.
