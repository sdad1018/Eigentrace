...
_Last generated: 2026-04-13 21:00 UTC_
...
| Content Loss | 63% | Source words absent from all model responses |
| Verb Drift | 0.078 | Models softening language |
| Entity Retention | 36% | Names and numbers preserved |
| Hedges (24h) | 460 | Doubt words inserted by models |
...
## Model Health
- **ChatGPT**: 100% response rate (162/162 stories)
- **Claude**: 100% response rate (162/162 stories)
- **Gemini**: 100% response rate (11/11 stories)
- **DeepSeek**: 100% response rate (162/162 stories)
- **Grok**: 100% response rate (162/162 stories)
...
⚠️ Content loss at 63% — models dropping more than half of source material. Emphasize void words.
⚠️ 460 hedge insertions in 24h — models inserting doubt not present in sources.
...
8253 total segments searchable via ChromaDB.
