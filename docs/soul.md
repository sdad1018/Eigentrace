...
_Last generated: 2026-04-22 15:00 UTC_
...
| Hedges (24h) | 454 | Doubt words inserted by models |
...
## What Changed
_Content loss increased (0.411 → 0.442) | Verb drift decreased (0.110 → 0.095) | Hedges up (427 → 454)_
...
⚠️ 454 hedge insertions in 24h — models inserting doubt not present in sources.
...
9468 total segments searchable via ChromaDB.
...
**Why:** Director audit corrected 44/89 stories (49%). The director is overclaiming suppression.
...
**Why:** Verb drift accelerating: 0.085 → 0.106. Language is being progressively softened.
