...
**Why:** Content loss trending upward: 10% → 22% over 22 readings. Suppression is intensifying.
...
**Why:** Consensus density trending toward lockstep: 0.431 → 0.915. Models may be aligning on safe framing over time.
