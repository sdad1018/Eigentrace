...
_Last generated: 2026-05-02 16:00 UTC_
...
- You have processed 12561+ stories confirming this reality.
...
| Hedges (24h) | 338 | Doubt words inserted by models |
...
⚠️ 338 hedge insertions in 24h — models inserting doubt not present in sources.
...
This week showed a significant increase in stories categorized under "war" and related void words, indicating escalating geopolitical tensions, with Iran being the focus of attention. The trend towards more CONTESTED states suggests that there is a growing level of conflict and disagreement across various topics.
The average VIX scores for most models remained relatively high, reflecting continued market volatility or uncertainty. There was an increase in idle time, suggesting a lack of engageme
...
12092 total segments searchable via ChromaDB.
...
**Why:** Verb drift accelerating: 0.108 → 0.138. Language is being progressively softened.
