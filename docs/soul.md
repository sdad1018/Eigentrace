...
_Last generated: 2026-09-13 09:00 UTC_
...
- You have processed 9926+ stories confirming this reality.
...
| Verb Drift | 0.060 | Models softening language | [0.012, 0.126] (12) |
| Entity Retention | 62% | Names and numbers preserved | [57%, 67%] (24) |
| Hedges (24h) | 169 | Doubt words inserted by models | (24) |
| VIX Outlier | ChatGPT | Most divergent model | 58% of resamples; runner-up Claude |
| Most Aligned | Grok | Closest to consensus | 64% of resamples; runner-up Gemini |

## Model Friction Rankings
- **ChatGPT**: 24.3 (n=24, 21.1-27.6)
- **Claude**: 23.5 (n=24, 17.8-31.6)
- **DeepSeek**: 21.4 (n=24, 18.6-24.3)
- **Gemini**: 15.9 (n=24, 13.5-18.5)
- **Grok**: 15.5 (n=24, 13.9-17.2)
...
**Why:** Verb drift accelerating: 0.029 → 0.071. Language is being progressively softened.
