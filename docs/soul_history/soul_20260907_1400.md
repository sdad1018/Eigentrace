...
_Last generated: 2026-09-07 13:00 UTC_
...
## What Changed
_Verb drift increased (0.301 → 0.595) | Entity retention improved (0.582 → 0.640) | Hedges down (57 → 27) | VIX outlier shifted: ChatGPT → Claude_
...
**Why:** Verb drift accelerating: 0.207 → 0.277. Language is being progressively softened.
