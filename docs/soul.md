...
This week saw a significant increase in stories related to war, with the category surpassing other topics by a large margin and many void words also being war-related. The proportion of idle time increased slightly compared to previous weeks while foraging and consolidation times remained relatively stable. There was an uptick in states of contention, indicating more disagreements or uncertainties, with CONTESTED states making up nearly 40% of the total.
