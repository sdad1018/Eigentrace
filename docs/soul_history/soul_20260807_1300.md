...
**Why:** Verb drift accelerating: 0.029 → 0.069. Language is being progressively softened.
...
**Why:** Consensus density trending toward lockstep: 0.660 → 0.927. Models may be aligning on safe framing over time.
