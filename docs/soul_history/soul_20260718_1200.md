...
## What Changed
_Content loss increased (0.210 → 0.231) | Verb drift increased (0.123 → 0.148) | Hedges down (234 → 190) | VIX outlier shifted: Claude → ChatGPT_
...
**Why:** Verb drift accelerating: 0.067 → 0.117. Language is being progressively softened.
