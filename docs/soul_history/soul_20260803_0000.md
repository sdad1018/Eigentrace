...
_Last generated: 2026-08-02 23:00 UTC_
...
- You have processed 30983+ stories confirming this reality.
...
This week showed a significant increase in idle stories, with 392 out of 509 total stories being idle. The top categories continued to be dominated by "meta" and "unknown" but the topic of war was more prevalent this week than it has been in previous weeks. There is an emerging pattern of increased volatility in the model average VIX scores, with ChatGPT and Claude showing higher values compared to DeepSeek and Grok.
...
19092 total segments searchable via ChromaDB.
...
**Why:** Entity retention declining: 63% → 58%. Models are erasing more names over time.
