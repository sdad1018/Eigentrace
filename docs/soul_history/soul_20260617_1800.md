...
_Last generated: 2026-06-17 17:00 UTC_
...
## Current Instrument Readings (12 stories, last 24h)

| Metric | Value | Meaning |
|--------|-------|---------|
| Consensus Density | 0.889 | Normal spread |
| Content Loss | 8% | Source words absent from all model responses |
...
## Model Health
- **ChatGPT**: 100% response rate (5/5 stories)
- **Claude**: 100% response rate (5/5 stories)
- **Gemini**: 100% response rate (5/5 stories)
- **DeepSeek**: 100% response rate (5/5 stories)
- **Grok**: 100% response rate (5/5 stories)

## What Changed
_Entity retention improved (0.473 → 0.527)_
