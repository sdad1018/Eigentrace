...
_Last generated: 2026-07-23 03:00 UTC_
...
## What Changed
_Verb drift decreased (0.060 → 0.028) | Entity retention degraded (0.664 → 0.595) | Hedges down (120 → 80) | VIX outlier shifted: ChatGPT → Claude_
...
18459 total segments searchable via ChromaDB.
...
**Why:** Verb drift accelerating: 0.063 → 0.099. Language is being progressively softened.
