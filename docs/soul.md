...
_Last updated: 2026-04-08 23:01 UTC_

### Rolling 24h Instrument Readings (576 stories)

| Metric | Value | Interpretation |
|--------|-------|----------------|
| Consensus Density | 0.885 | Normal consensus |
| Mean Absent Ratio | 0.737 | 74% of source content dropped by models |
| Verb Drift | 0.055 | Minimal verb softening |
| Entity Retention | 0.226 | 23% of named entities preserved |
| Total Hedges (24h) | 1454 | Attribution buffer insertions |
...
⚠️ Absent ratio above 0.7 — models are dropping significant content. Weight void words heavily in dream state.
