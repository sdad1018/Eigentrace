...
_Last generated: 2026-09-14 20:00 UTC_
...
| Content Loss | 20% | Source words absent from all model responses | [16%, 24%] (27) |
| Verb Drift | 0.070 | Models softening language | [0.027, 0.122] (10) |
...
- **ChatGPT**: 21.2 (n=30, 18.8-23.8)
- **DeepSeek**: 18.4 (n=30, 16.7-20.3)
- **Claude**: 17.1 (n=30, 15.3-18.9)
- **Gemini**: 13.6 (n=30, 12.2-15.1)
- **Grok**: 13.0 (n=30, 11.5-14.7)
...
**Why:** Verb drift accelerating: 0.043 → 0.066. Language is being progressively softened.
