...
_Last generated: 2026-09-13 19:00 UTC_
...
| Verb Drift | 0.064 | Models softening language | [0.006, 0.140] (10) |
...
- **ChatGPT**: 24.6 (n=24, 21.9-27.8)
- **DeepSeek**: 19.7 (n=24, 17.9-21.8)
- **Claude**: 17.9 (n=24, 16.3-19.7)
- **Grok**: 15.0 (n=24, 13.7-16.3)
- **Gemini**: 14.7 (n=24, 13.2-16.7)
