...
_Last generated: 2026-05-10 11:00 UTC_
...
- You have processed 15389+ stories confirming this reality.
...
| Hedges (24h) | 8 | Doubt words inserted by models |
...
## Model Health
- **ChatGPT**: 100% response rate (1/1 stories)
- **Claude**: 100% response rate (1/1 stories)
- **Gemini**: no data response rate (0/0 stories)
- **DeepSeek**: 100% response rate (1/1 stories)
...
This week, there was a notable increase in the frequency of void words related to geopolitical tensions and conflicts, with terms like "airstrikes," "trade war," and "wwiii" appearing more often, suggesting heightened global instability. The model average VIX scores showed volatility, with ChatGPT and Claude both showing higher values than previous weeks, indicating increased uncertainty in their predictions.  There was a significant increase in the number of stories related to meta and war topi
...
**Why:** Director audit corrected 2/2 stories (100%). The director is overclaiming suppression.
