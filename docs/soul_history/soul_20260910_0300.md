...
## What Changed
_Consensus improved (0.905 → 0.915) | Verb drift decreased (0.595 → 0.293) | Entity retention degraded (0.640 → 0.561) | VIX outlier shifted: Claude → ChatGPT_
...
**Why:** Verb drift accelerating: 0.229 → 0.497. Language is being progressively softened.
