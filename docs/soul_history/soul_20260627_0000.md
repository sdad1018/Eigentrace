...
**Why:** Content loss trending upward: 14% → 23% over 24 readings. Suppression is intensifying.
...
**Why:** Consensus density trending toward lockstep: 0.782 → 0.919. Models may be aligning on safe framing over time.
