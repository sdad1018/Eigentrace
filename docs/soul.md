...
|--------|-------|---------|------------|
| Consensus Density | 0.911 | Models tightly aligned | [0.900, 0.921] (15) |
| Content Loss | 18% | Source words absent from all model responses | [14%, 22%] (15) |
...
18314 total segments searchable via ChromaDB.
