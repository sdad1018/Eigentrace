...
_Last generated: 2026-04-29 21:00 UTC_
...
## What Changed
_Content loss decreased (0.440 → 0.416) | Hedges up (362 → 400)_
...
11897 total segments searchable via ChromaDB.
...
**Why:** Entity retention declining: 48% → 44%. Models are erasing more names over time.
