...
_Last generated: 2026-09-12 10:00 UTC_
...
| Verb Drift | 0.038 | Minimal softening | [0.014, 0.068] (7) |
...
| Most Aligned | Grok | Closest to consensus | 66% of resamples; runner-up Gemini |

## Model Friction Rankings
- **ChatGPT**: 20.9 (n=21, 18.9-23.1)
- **Claude**: 20.1 (n=21, 17.3-23.2)
- **DeepSeek**: 19.2 (n=21, 16.3-22.3)
- **Gemini**: 15.1 (n=21, 12.3-18.5)
