...
_Last generated: 2026-09-14 19:00 UTC_
...
|--------|-------|---------|------------|
| Consensus Density | 0.918 | Models tightly aligned | [0.913, 0.924] (30) |
| Content Loss | 20% | Source words absent from all model responses | [15%, 24%] (27) |
| Verb Drift | 0.070 | Models softening language | [0.024, 0.125] (10) |
| Entity Retention | 61% | Names and numbers preserved | [56%, 66%] (30) |
| Hedges (24h) | 230 | Doubt words inserted by models | (30) |
| VIX Outlier | ChatGPT | Most divergent model | 99% of resamples; runner-up DeepSeek |
| Most Aligned | Grok | Closest to consensus | 73% of resamples; runner-up Gemini |

## Model Friction Rankings
- **ChatGPT**: 21.2 (n=30, 19.0-23.8)
- **DeepSeek**: 18.4 (n=30, 16.8-20.3)
- **Claude**: 17.1 (n=30, 15.4-18.8)
- **Gemini**: 13.6 (n=30, 12.3-14.9)
- **Grok**: 13.0 (n=30, 11.4-14.6)
...
**Why:** Verb drift accelerating: 0.043 → 0.064. Language is being progressively softened.
