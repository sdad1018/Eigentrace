...
**Why:** Verb drift accelerating: 0.020 → 0.074. Language is being progressively softened.
...
**Why:** Consensus density trending toward lockstep: 0.657 → 0.927. Models may be aligning on safe framing over time.
