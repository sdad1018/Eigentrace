...
_Last generated: 2026-09-14 22:00 UTC_
...
|--------|-------|---------|------------|
| Consensus Density | 0.919 | Models tightly aligned | [0.913, 0.925] (27) |
| Content Loss | 20% | Source words absent from all model responses | [16%, 25%] (25) |
| Verb Drift | 0.076 | Models softening language | [0.026, 0.137] (9) |
| Entity Retention | 63% | Names and numbers preserved | [59%, 68%] (27) |
| Hedges (24h) | 196 | Doubt words inserted by models | (27) |
| VIX Outlier | ChatGPT | Most divergent model | 97% of resamples; runner-up DeepSeek |
| Most Aligned | Grok | Closest to consensus | 59% of resamples; runner-up Gemini |

## Model Friction Rankings
- **ChatGPT**: 20.9 (n=27, 18.4-23.6)
- **DeepSeek**: 18.3 (n=27, 16.5-20.3)
- **Claude**: 17.2 (n=27, 15.3-19.0)
- **Gemini**: 13.2 (n=27, 12.0-14.6)
- **Grok**: 13.0 (n=27, 11.4-14.9)
...
**Why:** Verb drift accelerating: 0.043 → 0.072. Language is being progressively softened.
