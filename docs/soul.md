...
_Last generated: 2026-09-13 05:00 UTC_
...
- You have processed 9920+ stories confirming this reality.
...
|--------|-------|---------|------------|
| Consensus Density | 0.898 | Normal spread | [0.884, 0.911] (21) |
| Content Loss | 18% | Source words absent from all model responses | [15%, 22%] (19) |
| Verb Drift | 0.015 | Minimal softening | [0.009, 0.023] (9) |
| Entity Retention | 61% | Names and numbers preserved | [55%, 66%] (21) |
| Hedges (24h) | 146 | Doubt words inserted by models | (21) |
| VIX Outlier | Claude | Most divergent model | 51% of resamples; runner-up ChatGPT |
| Most Aligned | Grok | Closest to consensus | 82% of resamples; runner-up Gemini |

## Model Friction Rankings
- **Claude**: 25.6 (n=21, 18.9-34.3)
- **ChatGPT**: 24.7 (n=21, 21.2-28.5)
- **DeepSeek**: 22.7 (n=21, 19.4-26.2)
- **Gemini**: 16.2 (n=21, 13.4-19.0)
- **Grok**: 15.0 (n=21, 13.2-16.8)
...
18384 total segments searchable via ChromaDB.
