...
_Last generated: 2026-09-15 00:00 UTC_
...
|--------|-------|---------|------------|
| Consensus Density | 0.919 | Models tightly aligned | [0.913, 0.925] (24) |
| Content Loss | 21% | Source words absent from all model responses | [17%, 26%] (22) |
| Verb Drift | 0.076 | Models softening language | [0.028, 0.133] (9) |
...
- **ChatGPT**: 20.7 (n=24, 17.8-23.7)
- **DeepSeek**: 18.5 (n=24, 16.4-20.8)
- **Claude**: 17.2 (n=24, 15.3-19.2)
- **Gemini**: 13.3 (n=24, 11.8-14.7)
- **Grok**: 13.1 (n=24, 11.3-15.0)
