...
_Last generated: 2026-09-14 21:00 UTC_
...
## Current Instrument Readings (29 measured of 29 stories, last 24h)

| Metric | Value | Meaning | 95% CI (n) |
|--------|-------|---------|------------|
| Consensus Density | 0.918 | Models tightly aligned | [0.913, 0.924] (29) |
| Content Loss | 20% | Source words absent from all model responses | [16%, 24%] (26) |
| Verb Drift | 0.076 | Models softening language | [0.025, 0.133] (9) |
| Entity Retention | 61% | Names and numbers preserved | [56%, 66%] (29) |
| Hedges (24h) | 221 | Doubt words inserted by models | (29) |
...
- **ChatGPT**: 21.3 (n=29, 19.0-24.0)
- **DeepSeek**: 18.5 (n=29, 16.6-20.5)
- **Claude**: 17.1 (n=29, 15.4-18.9)
- **Gemini**: 13.3 (n=29, 12.0-14.6)
- **Grok**: 13.0 (n=29, 11.5-14.8)
...
Sample: 29 measured of 29 stories in the window. Any metric whose 95% interval straddles its warning threshold is provisional; say so.
