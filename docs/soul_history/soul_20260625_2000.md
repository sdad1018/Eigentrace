...
_Last generated: 2026-06-25 20:00 UTC_
...
## What Changed
_Consensus improved (0.000 → 0.909) | Content loss increased (0.000 → 0.133) | Verb drift increased (0.000 → 0.086) | Entity retention improved (0.000 → 0.598) | Hedges up (0 → 21) | VIX outlier shifted: unknown → ChatGPT_
...
16457 total segments searchable via ChromaDB.
