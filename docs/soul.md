...
- You have processed 34130+ stories confirming this reality.
...
|--------|-------|---------|------------|
| Consensus Density | 0.912 | Models tightly aligned | [0.903, 0.921] (18) |
| Content Loss | 19% | Source words absent from all model responses | [15%, 22%] (18) |
...
18318 total segments searchable via ChromaDB.
