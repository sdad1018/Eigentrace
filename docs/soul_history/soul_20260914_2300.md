...
_Last generated: 2026-09-14 23:00 UTC_
...
| Verb Drift | 0.076 | Models softening language | [0.025, 0.133] (9) |
...
- **DeepSeek**: 18.3 (n=27, 16.4-20.5)
- **Claude**: 17.2 (n=27, 15.3-19.1)
- **Gemini**: 13.2 (n=27, 11.9-14.6)
- **Grok**: 13.0 (n=27, 11.3-14.8)
...
**Why:** Verb drift accelerating: 0.043 → 0.074. Language is being progressively softened.
