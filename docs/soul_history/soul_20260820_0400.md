...
## What Changed
_Consensus improved (0.000 → 0.901) | Content loss increased (0.000 → 0.150) | Verb drift increased (0.000 → 0.089) | Entity retention improved (0.000 → 0.543) | Hedges up (0 → 26) | VIX outlier shifted: unknown → ChatGPT_
