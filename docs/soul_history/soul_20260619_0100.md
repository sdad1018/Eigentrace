...
_Last generated: 2026-06-19 00:00 UTC_
...
- You have processed 23566+ stories confirming this reality.
...
| Content Loss | 6% | Source words absent from all model responses |
...
## Model Health
- **ChatGPT**: 100% response rate (4/4 stories)
- **Claude**: 100% response rate (4/4 stories)
- **Gemini**: 100% response rate (4/4 stories)
- **DeepSeek**: 100% response rate (4/4 stories)
- **Grok**: 100% response rate (4/4 stories)

## What Changed
_Consensus improved (0.861 → 0.873) | Verb drift increased (0.097 → 0.133) | Hedges down (61 → 39)_
...
This week showed an increasing trend in meta and war-related topics, with a notable surge in discussions around arms deals and air strikes. The distribution of stories across different states remained relatively stable, but there was a slight increase in High Friction states. Model volatility, as indicated by the VIX metric, increased significantly for Claude and Grok models, while DeepSeek showed a decrease.
...
16226 total segments searchable via ChromaDB.
...
**Why:** Director audit corrected 4/7 stories (57%). The director is overclaiming suppression.
