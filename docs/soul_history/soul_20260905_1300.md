...
_Last generated: 2026-09-05 12:00 UTC_
...
## What Changed
_Verb drift increased (0.064 → 0.134)_
...
### [add_trend_beat]
**Why:** Trend data available (5 metrics tracked over time) but not reported in broadcast. Increasing: density, absent_ratio, verb_drift, hedges. Decreasing: entity_retention.
...
**Why:** Verb drift accelerating: 0.042 → 0.056. Language is being progressively softened.
...
**Why:** Consensus density trending toward lockstep: 0.867 → 0.913. Models may be aligning on safe framing over time.
