...
**Why:** Verb drift accelerating: 0.044 → 0.078. Language is being progressively softened.
...
**Why:** Consensus density trending toward lockstep: 0.743 → 0.911. Models may be aligning on safe framing over time.
