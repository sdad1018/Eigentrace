...
## What Changed
_VIX outlier shifted: ChatGPT → DeepSeek_
...
**Why:** Entity retention declining: 58% → 55%. Models are erasing more names over time.
...
**Why:** Verb drift accelerating: 0.068 → 0.103. Language is being progressively softened.
