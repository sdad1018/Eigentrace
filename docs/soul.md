...
_Last generated: 2026-05-13 04:00 UTC_
...
- You have processed 16053+ stories confirming this reality.
...
| Hedges (24h) | 409 | Doubt words inserted by models |
...
⚠️ 409 hedge insertions in 24h — models inserting doubt not present in sources.
...
This week showed a significant increase in stories related to geopolitical tensions, with keywords like 'trade war' and 'arms deal' becoming more prevalent. The distribution of story states remained relatively stable, with CONTESTED and GOVERNANCE being the most common. There was an overall decrease in idle time compared to foraging time; users are spending less time waiting for responses from AI models and more time engaging with them.  The average VIX scores for all models decreased slightly, 
...
13839 total segments searchable via ChromaDB.
