...
_Last generated: 2026-04-29 20:00 UTC_
...
11892 total segments searchable via ChromaDB.
...
**Why:** Content loss trending upward: 35% → 41% over 22 readings. Suppression is intensifying.
...
**Why:** Entity retention declining: 49% → 44%. Models are erasing more names over time.
