...
_Last generated: 2026-05-02 17:00 UTC_
...
- You have processed 12565+ stories confirming this reality.
...
| Content Loss | 39% | Source words absent from all model responses |
| Verb Drift | 0.153 | Models softening language |
| Entity Retention | 50% | Names and numbers preserved |
| Hedges (24h) | 370 | Doubt words inserted by models |
...
⚠️ 370 hedge insertions in 24h — models inserting doubt not present in sources.
...
This week, there was a significant increase in stories related to war and geopolitical tensions (205), with a notable pattern of void words such as "rouhani" and "arms deal", suggesting a focus on Middle Eastern conflicts, notably Iran. The distribution of states shifted towards more contested situations (170), indicating heightened debates or disagreements. Additionally, there was an increase in the average VIX scores across all models, with Claude showing the highest volatility at 20.0, sugges
...
12096 total segments searchable via ChromaDB.
...
**Why:** Director audit corrected 33/65 stories (51%). The director is overclaiming suppression.
...
### [flag_verb_softening]
**Why:** Verb drift at 0.153 — models actively softening language.
...
**Why:** Verb drift accelerating: 0.112 → 0.144. Language is being progressively softened.
