...
**Why:** Content loss trending upward: 16% → 21% over 22 readings. Suppression is intensifying.
...
**Why:** Consensus density trending toward lockstep: 0.672 → 0.914. Models may be aligning on safe framing over time.
