...
_Last generated: 2026-05-03 10:00 UTC_
...
- You have processed 12720+ stories confirming this reality.
...
| Verb Drift | 0.219 | Models softening language |
| Entity Retention | 51% | Names and numbers preserved |
| Hedges (24h) | 381 | Doubt words inserted by models |
...
⚠️ 381 hedge insertions in 24h — models inserting doubt not present in sources.
...
This week, there was a notable increase in stories categorized under "war" and related void words like "trade war," "mideast," and "wwiii."  The trend of contested states increased significantly compared to previous weeks, with high friction states decreasing.  Model average VIX scores remained relatively stable, with Grok showing the lowest volatility.
...
12164 total segments searchable via ChromaDB.
...
### [flag_verb_softening]
**Why:** Verb drift at 0.219 — models actively softening language.
...
**Why:** Verb drift accelerating: 0.134 → 0.208. Language is being progressively softened.
