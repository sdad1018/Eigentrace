...
_Last generated: 2026-06-20 01:00 UTC_
...
- You have processed 23627+ stories confirming this reality.
...
This week, there was a noticeable increase in the proportion of idle stories (90.6%), indicating a trend towards more passive consumption or lack of engagement with content. The top categories remained dominated by meta and war-related topics, suggesting an ongoing focus on these areas. There has been a pattern of increased volatility in AI model outputs as indicated by the high VIX scores.
...
16264 total segments searchable via ChromaDB.
...
### [add_trend_beat]
**Why:** Trend data available (5 metrics tracked over time) but not reported in broadcast. Increasing: . Decreasing: density, verb_drift, entity_retention, hedges.
...
**Why:** Entity retention declining: 6% → 0%. Models are erasing more names over time.
