...
_Last generated: 2026-04-20 03:00 UTC_
...
| Content Loss | 60% | Source words absent from all model responses |
...
## What Changed
_Verb drift increased (0.075 → 0.091)_
...
⚠️ Content loss at 60% — models dropping more than half of source material. Emphasize void words.
...
9208 total segments searchable via ChromaDB.
...
**Why:** Director audit corrected 74/173 stories (43%). The director is overclaiming suppression.
