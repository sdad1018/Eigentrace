...
_Last generated: 2026-04-30 00:00 UTC_
...
11904 total segments searchable via ChromaDB.
...
**Why:** Content loss trending upward: 36% → 42% over 23 readings. Suppression is intensifying.
...
**Why:** Entity retention declining: 47% → 43%. Models are erasing more names over time.
