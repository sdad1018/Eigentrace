...
## What Changed
_Content loss increased (0.150 → 0.237) | Entity retention improved (0.543 → 0.581) | Hedges up (26 → 56)_
...
**Why:** Content loss trending upward: 0% → 5% over 23 readings. Suppression is intensifying.
