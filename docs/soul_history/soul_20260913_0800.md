...
_Last generated: 2026-09-13 08:00 UTC_
...
| Verb Drift | 0.071 | Models softening language | [0.012, 0.147] (10) |
| Entity Retention | 62% | Names and numbers preserved | [57%, 68%] (21) |
| Hedges (24h) | 151 | Doubt words inserted by models | (21) |
| VIX Outlier | Claude | Most divergent model | 48% of resamples; runner-up ChatGPT |
| Most Aligned | Grok | Closest to consensus | 85% of resamples; runner-up Gemini |

## Model Friction Rankings
- **Claude**: 24.3 (n=21, 17.8-33.0)
- **ChatGPT**: 24.0 (n=21, 20.4-27.6)
- **DeepSeek**: 21.2 (n=21, 18.2-24.5)
- **Gemini**: 16.4 (n=21, 13.8-19.1)
...
**Why:** Verb drift accelerating: 0.029 → 0.050. Language is being progressively softened.
