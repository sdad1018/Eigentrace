...
_Last updated: 2026-04-10 04:00 UTC_

### Rolling 24h Instrument Readings (136 stories)

| Metric | Value | Interpretation |
|--------|-------|----------------|
| Consensus Density | 0.9 | Normal consensus |
| Mean Absent Ratio | 0.553 | 55% of source content dropped by models |
| Verb Drift | 0.024 | Minimal verb softening |
| Entity Retention | 0.331 | 33% of named entities preserved |
| Total Hedges (24h) | 331 | Attribution buffer insertions |
