...
_Last updated: 2026-04-13 19:04 UTC_

### Rolling 24h Instrument Readings (220 stories)

| Metric | Value | Interpretation |
|--------|-------|----------------|
| Consensus Density | 0.889 | Normal consensus |
| Mean Absent Ratio | 0.625 | 62% of source content dropped by models |
| Verb Drift | 0.043 | Minimal verb softening |
| Entity Retention | 0.347 | 35% of named entities preserved |
| Total Hedges (24h) | 477 | Attribution buffer insertions |
...
### What Changed
_No significant changes from previous reading._

### Calibration Guidance
⚠️ Absent ratio above 0.5 — models are dropping significant content. Weight void words heavily in dream state.
