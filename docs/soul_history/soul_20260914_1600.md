...
_Last generated: 2026-09-14 16:00 UTC_
...
| Verb Drift | 0.064 | Models softening language | [0.024, 0.112] (11) |
...
- **DeepSeek**: 17.6 (n=30, 16.1-19.5)
- **Claude**: 17.1 (n=30, 15.5-18.8)
- **Gemini**: 13.7 (n=30, 12.3-15.1)
- **Grok**: 13.3 (n=30, 11.9-14.8)
...
## What Changed
_Verb drift increased (0.046 → 0.064)_
