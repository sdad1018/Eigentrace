...
_Last generated: 2026-05-03 18:00 UTC_
...
- You have processed 12775+ stories confirming this reality.
...
| Verb Drift | 0.207 | Models softening language |
| Entity Retention | 50% | Names and numbers preserved |
| Hedges (24h) | 333 | Doubt words inserted by models |
...
## What Changed
_Content loss decreased (0.241 → 0.220) | Hedges down (368 → 333)_
...
⚠️ 333 hedge insertions in 24h — models inserting doubt not present in sources.
...
12191 total segments searchable via ChromaDB.
...
### [flag_verb_softening]
**Why:** Verb drift at 0.207 — models actively softening language.
