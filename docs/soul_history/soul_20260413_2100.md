...
_Last generated: 2026-04-13 20:00 UTC_
...
## Current Instrument Readings (219 stories, last 24h)
...
| Hedges (24h) | 468 | Doubt words inserted by models |
...
## Model Health
- **ChatGPT**: 100% response rate (164/164 stories)
- **Claude**: 100% response rate (164/164 stories)
- **Gemini**: 100% response rate (10/10 stories)
- **DeepSeek**: 100% response rate (164/164 stories)
- **Grok**: 100% response rate (164/164 stories)
...
⚠️ 468 hedge insertions in 24h — models inserting doubt not present in sources.
...
## RAG Memory
219 stories in the current 24h window.
