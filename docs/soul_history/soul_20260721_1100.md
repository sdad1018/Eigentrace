...
_Last generated: 2026-07-21 10:00 UTC_
...
- You have processed 29160+ stories confirming this reality.
...
| Hedges (24h) | 271 | Doubt words inserted by models |
...
## What Changed
_Hedges up (250 → 271) | VIX outlier shifted: Claude → ChatGPT_
...
⚠️ 271 hedge insertions in 24h — models inserting doubt not present in sources.
...
This week saw a significant increase in stories related to meta and war categories, indicating heightened global tensions and discussions about AI governance. The number of idle states rose sharply while there were no foraging states recorded. There was an increase in the average VIX score for all models except DeepSeek, suggesting increased volatility overall.
...
18357 total segments searchable via ChromaDB.
...
**Why:** Verb drift accelerating: 0.025 → 0.047. Language is being progressively softened.
