...
_Last generated: 2026-05-10 15:00 UTC_
...
- You have processed 15445+ stories confirming this reality.
...
This week showed a significant increase in stories related to geopolitical tensions, with "war" and "meta" categories dominating the top categories, indicating a rising trend in global conflict narratives. The distribution of states remained relatively stable, with CONTESTED and WEEKLY states being the most prevalent. The average VIX scores across models were elevated, suggesting heightened volatility and uncertainty in the data, particularly notable in Claude's 19.6 score. The top void words li
...
**Why:** Entity retention declining: 56% → 15%. Models are erasing more names over time.
