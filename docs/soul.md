...
_Last generated: 2026-06-11 07:00 UTC_
...
- You have processed 22527+ stories confirming this reality.
...
|--------|-------|---------|
| Consensus Density | 0.877 | Normal spread |
| Content Loss | 15% | Source words absent from all model responses |
| Verb Drift | 0.149 | Models softening language |
...
## What Changed
_Verb drift increased (0.082 → 0.149) | Hedges up (135 → 167)_
...
This week, there was a significant increase in the number of stories categorized under 'meta' and a slight decrease in 'war'. The distribution of story states showed a rise in 'CONTESTED' states but a decline in 'LOCKSTEP'. There is an emerging pattern of increased volatility in model responses, with Grok showing significantly higher VIX compared to other models.
...
15849 total segments searchable via ChromaDB.
...
**Why:** Director audit corrected 13/30 stories (43%). The director is overclaiming suppression.
...
### [flag_verb_softening]
**Why:** Verb drift at 0.149 — models actively softening language.
