...
_Last generated: 2026-09-06 09:00 UTC_
...
| Verb Drift | 0.384 | Models softening language |
...
## What Changed
_Verb drift increased (0.367 → 0.384) | Hedges down (111 → 83)_
...
### [flag_verb_softening]
**Why:** Verb drift at 0.384 — models actively softening language.
...
**Why:** Verb drift accelerating: 0.161 → 0.367. Language is being progressively softened.
