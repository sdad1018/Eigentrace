...
**Why:** Content loss trending upward: 3% → 16% over 24 readings. Suppression is intensifying.
...
**Why:** Verb drift accelerating: 0.016 → 0.042. Language is being progressively softened.
...
**Why:** Consensus density trending toward lockstep: 0.216 → 0.910. Models may be aligning on safe framing over time.
