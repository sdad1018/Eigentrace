...
_Last generated: 2026-09-14 17:00 UTC_
...
|--------|-------|---------|------------|
| Consensus Density | 0.919 | Models tightly aligned | [0.914, 0.924] (30) |
| Content Loss | 19% | Source words absent from all model responses | [15%, 24%] (27) |
| Verb Drift | 0.064 | Models softening language | [0.024, 0.116] (11) |
...
- **ChatGPT**: 20.2 (n=30, 18.3-22.1)
- **DeepSeek**: 17.6 (n=30, 16.1-19.4)
- **Claude**: 17.1 (n=30, 15.4-18.9)
- **Gemini**: 13.7 (n=30, 12.2-15.1)
- **Grok**: 13.3 (n=30, 11.9-14.9)
