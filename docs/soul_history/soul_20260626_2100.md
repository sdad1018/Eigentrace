...
**Why:** Content loss trending upward: 12% → 20% over 24 readings. Suppression is intensifying.
...
**Why:** Consensus density trending toward lockstep: 0.651 → 0.915. Models may be aligning on safe framing over time.
