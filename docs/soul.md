...
_Last generated: 2026-04-29 15:00 UTC_
...
11879 total segments searchable via ChromaDB.
...
**Why:** Content loss trending upward: 34% → 38% over 22 readings. Suppression is intensifying.
...
**Why:** Entity retention declining: 51% → 46%. Models are erasing more names over time.
